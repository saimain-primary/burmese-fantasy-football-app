<template>
  <template v-if="loading">
    ...
    <v-card
      elevation="0"
      class="bg-grey-lighten-2 mt-5 py-3 px-3 mx-3"
      style="height: 160px"
    >
    </v-card>
    <v-card
      elevation="0"
      class="bg-grey-lighten-2 mt-3 py-3 px-3 mx-3"
      style="height: 100px"
    >
    </v-card>
    <v-card
  ...
  <template v-else>
    <v-card elevation="0" class="mx-auto">
      <template v-if="fixtureDetail.fixtures">
        ...
        <v-card class="px-3">
          <div
            class="bg-grey-lighten-3 py-1 px-2 mt-5 d-flex justify-space-between align-center mb-3"
          >
          ...
          >
            <div
              class="d-flex justify-space-between align-center text-body-2 px-3 mb-1"
            >
              <p>Your Prediction</p>
              <p class="">
            ...
            <div
              class="mb-1 d-flex justify-space-between align-center text-body-2 px-3"
            >
          ...
          <div
            class="mt-3 bg-grey-lighten-3 py-1 px-2 d-flex justify-space-between align-center mb-3"
          >
          ...
          <div
            class="mt-3 bg-grey-lighten-3 py-1 mb-3 px-2 d-flex justify-space-between align-center"
          >
          ...
          <div
            class="bg-grey-lighten-3 py-1 mt-3 mb-3 px-2 d-flex justify-space-between align-center"
          >
          ...
          <div
            class="mt-3 bg-grey-lighten-3 py-1 px-2 d-flex justify-space-between align-center"
          >
