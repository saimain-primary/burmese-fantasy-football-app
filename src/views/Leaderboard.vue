<template>
    ...
    <v-container>
        <v-row>
            <v-col>
                <p class="mb-3 font-weight-medium text-body-1">
                    Top Predictors
                </p>
                        ...
                        >
                            ...
                            >
                                <div class="d-flex justify-start align-center">
                                    ...
                                    <div class="ml-5">
                                        <p class="text-h6">
                                            {{ firstUserLeaderboard.user.name }}
                                        </p>
                                        <p
                                            class="text-subtitle-1 font-weight-medium"
                                        >
                                            {{ firstUserLeaderboard.sum }}
                                            Points
                                        </p>
                                    </div>
                                </div>
                                <div class="">
                                    <v-btn
                                        @click="
                                            viewDetail(firstUserLeaderboard)
                                        "
                                        size="x-small"
