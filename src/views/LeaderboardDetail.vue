      ...
      <v-col>
        ...
        <v-card v-else class="text-white gd-bg">
          <div class="d-flex flex-no-wrap justify-start">
            <div
              class="pa-1 ma-5 mr-2 bg-white rounded-lg d-inline-block elevation-1"
            >
            ...
            <div class="" v-if="leaderboardDetail?.results">
              ...
              >
                ...
                <div class="mt-5">
                  ...
                  <div
                    class="bg-grey-lighten-3 px-3 d-flex justify-center align-center mb-3"
                  >
